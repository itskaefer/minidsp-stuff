...
inputs.prototype.startSerial = function() {
  ...
  port.open(function(t) {
    if (t) return console.log("INPUTS: Error opening port: ", t.message);
...
inputs.prototype.sendSerialMessage = function(e) {
  debug && console.log("INPUTS: SENDING SERIAL MESSAGE: " + e),
...
inputs.prototype.setMute = function(e) {
  debug && console.log("INPUTS: SET MUTE " + e);
  var t = "\rSET MUTE " + e + "\r";
  return this.sendSerialMessage(t)
},
inputs.prototype.pushMute = function(e) {
  if (debug && console.log("INPUTS: MUTE----------------------------------------" + e + "--------------------"), "TRUE" === e ? currentmute = !0 : "FALSE" === e && (currentmute = !1), currentmute !== stateMute) {
...
inputs.prototype.pushDSP = function(e) {
  var t;
  switch (debug && console.log("INPUTS: DSP----------------------------------------" + e + "--------------------"), e) {
  case "1111111":
    t = {
      quality: "enhanced",
      type: "minidsp",
...
inputs.prototype.pushCMD = function(e) {
  ...
  case "PAUSE":
    ...
    // added by itskaefer - 11/01/2024
    console.log("INPUTS: PAUSE pushed on remote");
  ...
  case "PREVIOUS":
    ...
    // added by itskaefer - 11/01/2024
    console.log("INPUTS: PREVIOUS pushed on remote");
  ...
  case "NEXT":
    ...
    // added by itskaefer - 11/01/2024
    console.log("INPUTS: NEXT pushed on remote");
